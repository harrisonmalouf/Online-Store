...
ga8 = Game.create :name => 'Project Gotham Racing 2', :price => '100.00', :release_date => '2003-11-18', :image => 'Project_Gotham_Racing_2_Coverart.png', :genre =>'Racing', :description => 'The original Project Gotham Racing hit when the Xbox launched, bringing fantastic control, beautiful representations of real-world cities... and a lot of little problems. PGR2 erases those potholes with one of the most engrossing single-player racing epics seen last generation. As you gradually improve, progress further, and unlock new cars and tracks, you begin to get a feel for the games subtly-tuned racing system and the global cities that make up its tracks.', :stock => 31
